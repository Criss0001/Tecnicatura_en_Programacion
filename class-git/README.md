...
ctrl + n 
> Creamos un archivo nuevo y escribimos en el, como lo hicimos antes

ctrl + s 
> Guardamos poniendo el nombre: historia.txt

git status 
> Vemos el estado del proyecto en tiempo real, esta en el área de trabajo
...
> Quitamos el archivo del área de preparación, cached significa que esta en memoria ram

git config 
> Tendremos la lista de como funciona la configuración

git config --list 
> Configuraciones por defecto, faltan cosas importantes

git config --list --show-origin 
> Veremos donde están las configuraciones guardadas

git config --global user.name "Cristian Farina"

git config --global user.email "cristianjfarina@gmail.com"
