# Ejercicio 1: Iterar un rango de 0 a 10 pero con incremento de 2 en 2, en lugar de 1 en 1
...
# Ejercicio 3: Crear un rango de números de 3 a 10 pero con incremento de 2 en 2
