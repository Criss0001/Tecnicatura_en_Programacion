...
class Orden{
    ...
    agregarProducto(producto){
        if(this._productos.length < Orden.getMAX_PRODUCTOS()){
            this._productos.push(producto);//Tenemos 2 tipos de sintáxis: 1
            this._productos[this._contadorProductosAgregados++] = producto; //segunda sintáxis
        } else {
